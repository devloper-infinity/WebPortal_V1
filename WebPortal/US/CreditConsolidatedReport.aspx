...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="card">
            <div class="card-body">
                <table class="table">
                    <tr>
                        ...
                        <td style="width: 100px;">
                            <button id="us_btnShow" class="btn btn-primary" onclick="return US_BindAllGrids();">Show</button>
                            &nbsp;
                            <button id="us_creditcons_btnexport" class="btn btn-primary" onclick="return us_creditcons_Submit()">Export to excel</button>
                ...
                <div class="card-header p-0 pt-1">
                    <ul class="nav nav-tabs" id="us_custom-tabs-one-tab" role="tablist">
                        <li class="nav-item">
    ...
    <div class="modal fade" id="us_waitingpanel" tabindex="-1" data-bs-backdrop="static" aria-hidden="true">
        <div class="modal-dialog text-center">
            ...
            <br />
            <span style="color: #fff; font-size: 24px; font-weight: bold; font-style: italic;" id="us_spntext">System is updating details. Please wait</span>
