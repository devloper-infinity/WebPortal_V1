<%@ Page Title="" Language="C#" MasterPageFile="~/US/USAdmin.Master" AutoEventWireup="true" CodeBehind="ConditionClearingReport.aspx.cs" Inherits="WebPortal.US.ConditionClearingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="condition-hero">
        <div class="condition-title-wrap">
            ...
            <div>
                <h1 class="condition-title">Condition Clearing Report</h1>
    ...
    <div class="condition-page">
        <div class="condition-card">
            <div class="condition-card-header">
                <div>
                    <h2 class="condition-card-title">Condition Queue</h2>
            ...
            <div class="card-body">
                <div class="main-container">
                    <div class="row align-items-end">
                        <div class="col-md-4">
                            <label for="Condition_FromDate" class="form-label">
                                <b>From Date</b>
                            </label>
                            <input type="date" class="my-input" id="Condition_FromDate" name="Condition_FromDate" />
                        </div>
                        <div class="col-md-4">
                            <label for="Condition_ToDate" class="form-label">
                                <b>Year</b>
                            </label>
                            <input type="date" class="my-input" id="Condition_ToDate" name="Condition_ToDate" />
                        </div>

                        <div class="col-md-4">
                            <label for="Condition_ToDate" class="form-label">
                            </label>
                            <button type="button" style="width: 100%" class="my-btn primary" id="btnConditionShow" onclick="return btnConditionShowReport();">Show</button>
                        </div>
                    </div>
                </div>
                <hr />
