<%@ Page Title="" Language="C#" MasterPageFile="~/US/USAdmin.Master" AutoEventWireup="true" CodeBehind="CanopySearch.aspx.cs" Inherits="WebPortal.US.CanopySearch" %>
  ...
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <script>
        $(document).ready(function () {
            us_getloansforglobalsearchCanopy();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="reqc-legend" aria-label="Process status legend">
                    <span class="reqc-legend-title">Process status:</span>
                    <span class="reqc-pill reqc-not-assigned"><i class="far fa-circle"></i> Not Started</span>
                    <span class="reqc-pill reqc-assigned"><i class="fas fa-user-clock"></i> Started</span>
                    <span class="reqc-pill reqc-completed"><i class="fas fa-check-circle"></i> Completed</span>
                </div>
                <table class="table table-bordered" style="width: 100%;" id="usglobalsearchcanopy_table"></table>
