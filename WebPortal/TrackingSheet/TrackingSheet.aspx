            ...
            <div class="olt-dialog-body">
                ...
                <div id="statusStep" class="ots-step">
                    <div class="olt-form">
                        ...
                        <div class="olt-field full olt-actions">
                            <button id="statusContinueButton" type="button" class="olt-btn" onclick="selectCompletionStatus()">Continue</button></div>
                    </div>
                </div>
                <div id="feedbackStep" class="ots-step">
                    ...
                    <div class="olt-feedback-form">
                        <div class="olt-field">
                            <label>Loan #</label><input id="fbLoanNumber" class="ots-disabled" disabled /></div>
                        <div class="olt-field">
                            <label>Client</label><input id="fbClient" class="ots-disabled" disabled /></div>
                        <div class="olt-field">
                            <label>UW Name</label><select id="fbErrorBy" onchange="bindFeedbackOwner()"><option value="">Select</option>
                            </select></div>
                        <div class="olt-field">
                            <label>Previous Process</label><input id="fbMarkedTo" class="ots-disabled" disabled /></div>
                        <div class="olt-field">
                            <label>Date Reviewed</label><input id="fbDateReviewed" class="ots-disabled" disabled /></div>
                        <div class="olt-field">
                            <label>QC Name</label><input id="fbFeedbackBy" class="ots-disabled" disabled /></div>
                        <div class="olt-field">
                            <label>QC Date</label><input id="fbQCDate" class="ots-disabled" disabled /></div>
                        <div class="olt-field">
                        ...
                        <div class="olt-field">
                            <label>Error Field</label><input id="fbErrorField" maxlength="500" /></div>
                        <div class="olt-field">
                            <label>Screen</label><input id="fbScreen" maxlength="1000" /></div>
                        <div class="olt-field">
                            <label>Error Type</label><input id="fbErrorType" maxlength="100" /></div>
                        <div class="olt-field">
                            <label>Feedback Type</label><input id="fbFeedbackType" maxlength="100" /></div>
                        <div class="olt-field">
                        ...
                        <div class="olt-field">
                            <label>Feedback Status</label><input id="fbFeedbackStatus" value="Pending" class="ots-disabled" disabled /></div>
                        <div class="olt-field">
                            <label>Source</label><input id="fbSource" value="Internal" class="ots-disabled" disabled /></div>
                        <div class="olt-field">
                            <label>Feedback Received Date</label><input id="fbReceivedDate" class="ots-disabled" disabled /></div>
                        <div class="olt-field span-3">
                            <label>Finding</label><textarea id="fbError" maxlength="2000"></textarea></div>
                    </div>
