...
<asp:Content ID="Body" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="olt-page">
        <div class="olt-hero">
          ...
          <%--  <div class="olt-links"><a href="ProjectTrackingFieldConfiguration.aspx">Project fields</a><a href="TrackingSheetConfiguration.aspx">Column configuration</a><a href="TrackingSheet.aspx">Tracking Sheet</a></div>--%>
        </div>
                ...
                <div class="olt-card-body">
                    <div class="olt-form">
                        <div class="olt-field wide">
                            <label>Project</label><select id="project"></select></div>
                        <div class="olt-field wide">
                            <label>Process</label><select id="process"><option value="">Select process</option>
                            </select></div>
                        <div class="olt-field">
                            <label>Sequence</label><input id="stageNo" type="number" min="1" value="1" /></div>
                        <div class="olt-field">
                        ...
                        <div class="olt-field wide">
                            <label class="olt-check">
                                <input id="feedback" type="checkbox" />
                                Feedback mandatory while completing</label></div>
                        <div class="olt-field full olt-actions">
                            <button type="button" class="olt-btn" onclick="saveFlow()">Save process</button>
                            <button type="button" class="olt-btn secondary" onclick="clearForm()">Clear</button></div>
                    </div>
                </div>
            </section>
            <section class="olt-card">
                ...
                <div class="olt-table-wrap">
                    <table class="olt-table">
                        ...
                        <tbody id="rows">
                            <tr>
                                <td colspan="5" class="olt-empty">Select a project.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
