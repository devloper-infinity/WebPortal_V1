...
namespace WebPortal.TrackingSheet
{
    public partial class ManagerAllocationPage : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string GetProjects() { return OLTrackingWeb.Json(new bllOLTracking().GetProjectsByUser(OLTrackingWeb.UserId)); }
        ...
        [WebMethod]
        public static string GetEligibleLoans(int projectId, string dealNumber, int processId) { Access(projectId); return OLTrackingWeb.Json(new bllOLTracking().GetEligibleLoans(projectId, dealNumber, processId)); }
        ...
        public static ManagerAllocationResult AllocateOrders(int projectId, string dealNumber, int processId, int targetUserId, string[] loanNumbers)
        {
            ...
            {
                return new ManagerAllocationResult { Success = false, Message = Message(ex) };
            }
        }
