...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sec-hero">
        <div>
            ...
            <h1 class="sec-title"><i class="fas fa-chart-line"></i>&nbsp;&nbsp;User Performance Report Marketing</h1>
            <p class="sec-subtitle">Review marketing summary, production, and attendance performance for the selected period.</p>
        </div>
        <div class="sec-hero-actions">
            <a href="UserPerformanceReport.aspx" class="upr-marketing-link">
