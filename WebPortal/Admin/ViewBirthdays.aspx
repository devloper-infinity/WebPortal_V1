    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2 callout callout-info">
                <div class="col-sm-6">
                    <h6 class="m-0"><i class="fas fa-copy"></i>&nbsp;&nbsp;<b>Today's Birthday</b></h6>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <table class="table" id="bdash_list" style="padding-top: 10px; width: 100%;">
                    <thead>
                        <tr>
                            <th class="sort border-top ps-3" style="text-wrap: nowrap; text-align:center;">Sr. #</th>
                            <th class="sort border-top ps-3" style="text-wrap: nowrap; text-align:center;">View</th>
