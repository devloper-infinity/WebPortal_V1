...
{
    public partial class NewJoineeReport : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string GetNewJoineeReport(string Month, string Year)
        {
            DataTable dt1 = new bllMaster().GetAllNewJoineeReport_Revised(Month, Year);
        ...
        {
            string FromDate = Convert.ToString(Request.Form["newjoin_from"]);
            string ToDate = Convert.ToString(Request.Form["newjoin_to"]);
            string FileName = Server.MapPath(@"~\ReportDocument\New_Joinee_Report_" + Convert.ToString(FromDate) + " to " + Convert.ToString(ToDate) + "_" + DateTime.Now.ToString("hhmmss") + ".xlsx");
            ...
            DataTable dt = new bllMaster().GetAllNewJoineeReport_Revised(FromDate, ToDate);
            if (dt != null)
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    sheet.Range["D1"].Value = "Branch";
                    sheet.Range["E1"].Value = "Department";
                    sheet.Range["F1"].Value = "Designation";
                    sheet.Range["G1"].Value = "Reporting Manager";
                    sheet.Range["H1"].Value = "Domain Head";
                    sheet.Range["I1"].Value = "Domain";
                    sheet.Range["J1"].Value = "Subdomain";
                    sheet.Range["K1"].Value = "Tenure";
