...
{
    public partial class ViewSelectedCandidates : System.Web.UI.Page
    {
        ...
        {
            DataTable dt1 = new bllRequisition().GetShortlistedCandidates(int.Parse(HttpContext.Current.User.Identity.Name.ToString()));
