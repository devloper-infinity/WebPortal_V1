...
namespace WebPortal.Admin
{
 public partial class RNRFeedback:System.Web.UI.Page
 {
  ...
  [WebMethod] 
        public static void Submit(long assignmentId,List<RnrAnswerInput> answers)
        {
            new RnrFeedbackRepository().Submit(assignmentId,RnrSecurity.EmployeeId,answers,RnrSecurity.Ip);
        }
 }
}
