<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="All.aspx.cs" Inherits="WebPortal.Admin.All" %>
        ...
        function bindData_pwd() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    productionData_table = $('#table_pwdHistory').DataTable({
                        data: dataArray,
                        dom: 'lftp',
                        scrollX: true,
                        destroy: true,
