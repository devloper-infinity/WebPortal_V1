    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2 callout callout-info">
                <div class="col-sm-6">
                    <h6 class="m-0"><i class="fas fa-copy"></i>&nbsp;&nbsp;<b>Dropout Employees Report</b></h6>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title"></h5>
                   ...
                   <table class="table" id="dropoutemployee_table" style="width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="sort border-top ps-3" style="text-wrap: nowrap;">Exit Formalities</th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
