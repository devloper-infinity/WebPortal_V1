<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="IncrementProposalReport_Step1.aspx.cs" Inherits="WebPortal.Admin.IncrementProposalReport_Step1" %>
    ...
    <div class="increment-shell">
        <div class="increment-header">
            <div>
                ...
                <div class="increment-subtitle">Single generalized workflow for due employees, proposal review, underwriting, and final salary insertion.</div>
            </div>
                ...
                <div class="tab-content" id="incprop_tabContent">
                    ...
                    <div class="tab-pane fade" id="incprop_selected" role="tabpanel" aria-labelledby="incprop_selected_tab">
                        <div class="increment-toolbar">
                            ...
                            <div class="increment-filter">
                                <label for="incprop_domainMode">Domain</label>
                                <select class="form-control form-control-sm" id="incprop_domainMode" onchange="return incprop_bindSelected();">
