...
{
    public partial class ServicingConsolidatedReport : System.Web.UI.Page
    {
        ...
        {
            DataTable dt1 = new bllReport().GetProjectInflow_Servicing(Month, Year);
        ...
        {
            DataTable dt1 = new bllReport().GetProjectQ_Servicing(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            foreach (DataRow dr in dt1.Rows)
            {
        ...
        {
            DataTable dt1 = new bllReport().GetAvgSalary_Servicing(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            foreach (DataRow dr in dt1.Rows)
            {
        ...
        {
            DataTable dt1 = new bllReport().GetIndividualPerformance_Servicing(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            foreach (DataRow dr in dt1.Rows)
            {
        ...
        {
            DataTable dt1 = new bllReport().GetProductionReport_Servicing(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            foreach (DataRow dr in dt1.Rows)
            {
        ...
        [WebMethod]
        public static string GetFeedbackDump_RQC(string Month, string Year)
        {

            DataTable dt1 = new bllReport().GetFeedbackdump_ServicingRQC(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            foreach (DataRow dr in dt1.Rows)
            {
        ...
        [WebMethod]
        public static string GetFeedbackDump_RQC_RW(string Month, string Year)
        {

            DataTable dt1 = new bllReport().GetFeedbackdump_ServicingRQC_RW(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            foreach (DataRow dr in dt1.Rows)
            {
        ...
        {
            DataTable dt1 = new bllReport().GetFeedbackdump_Servicing(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            foreach (DataRow dr in dt1.Rows)
            {
        ...
        [WebMethod]
        public static string GetFeedbackDump_1(string Month, string Year)
        {
            DataTable dt1 = new bllReport().GetFeedbackdumpEnglish_Servicing(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            foreach (DataRow dr in dt1.Rows)
            {
        ...
        {
            DataTable dt1 = new bllReport().GetReviewerQ_Servicing(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            if (dt1 != null)
            {
        ...
        {
            DataTable dt1 = new bllReport().GetQualityQ_Servicing(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            if (dt1 != null)
            {
        ...
        {
            DataTable dt1 = new bllReport().GetErrorTrendingAll_Servicing(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            if (dt1 != null)
            {
        ...
        {
            DataTable dt1 = new bllReport().GetWeeklyTrending_Servicing(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            if (dt1 != null)
            {
        ...
        {
            DataTable dt1 = new bllReport().GetSegmentQ_Servicing(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            if (dt1 != null)
            {
        ...
        {
            DataTable dt1 = new bllReport().GetMonthlyTrending_Servicing(Month, Year);
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            Dictionary<string, object> row;
            if (dt1 != null)
            {
        ...
        protected void btn1_Click(object sender, EventArgs e)
        {
            ...
            string Month = Convert.ToString(Request.Form["servcons_month"]);
            string Year = Convert.ToString(Request.Form["servcons_year"]);

            //FileName = Server.MapPath(@"~\ReportDocument\Servicing_Consolidated_Report_" + Convert.ToString(Month) + "-" + Convert.ToString(Year) + DateTime.Now.ToString("hhmmss") + ".xlsx");
            ...
            using (var workbook = new XLWorkbook(filePath))
            {
                ...
                if (sheetIndexToDelete >= 0 && sheetIndexToDelete < workbook.Worksheets.Count)
                {
                    ...
                    worksheet = workbook.Worksheet(1);
                    workbook.Worksheets.Delete(worksheet.Name);
                    worksheet = workbook.Worksheet(17);
                    workbook.Worksheets.Delete(worksheet.Name);
                }
                else
                {
        ...
        public void FormatExcel(string FileName)
        {
            ...
            DataTable dtInflow = new bllReport().GetProjectInflow_Servicing(Month, Year);
            if (dtInflow != null)
            {
        ...
        public static int CreateProjectInflow(string Month, string Year)
        {
            ...
            //string Month = Convert.ToString(HttpContext.Current.Request.Form["creditcons_month"]);
            //string Year = Convert.ToString(HttpContext.Current.Request.Form["creditcons_year"]);
            FileName = HttpContext.Current.Server.MapPath(@"~\ReportDocument\Servicing_Consolidated_Report_" + Convert.ToString(Month) + "-" + Convert.ToString(Year) + DateTime.Now.ToString("hhmmss") + ".xlsx");
        ...
        public static int ProjectQ(string Month, string Year)
        {
            ...
            #region Project Q
            sheet = book.Worksheets.Add("Project Q");
            DataTable dtProject = new bllReport().GetProjectQ_Servicing(Month, Year);
            if (dtProject != null)
            {
                dtProject.Columns.Remove("Total Opportunities");
                dtProject.Columns.Remove("Missed Opprtunities");
                dtProject.Columns.Remove("Review Quality");
                dtProject.Columns.Remove("QCer Quality");
                dtProject.Columns.Remove("ReQCer Quality");
                dtProject.Columns.Remove("Client Quality");
                sheet.InsertDataTable(dtProject, true, 1, 1);
                string Col = GetColumnName(dtProject.Columns.Count - 1);
                CellRange range = sheet.Range["A1:" + Col + "1"];
                HeaderFormat_Static(range);
        ...
        public static int SegmentQ(string Month, string Year)
        {
            ...
            #region Segment Q
            sheet = book.Worksheets.Add("Segment Q");
            DataTable dtSeg = new bllReport().GetSegmentQ_Servicing(Month, Year);
            if (dtSeg != null)
            {
                sheet.InsertDataTable(dtSeg, true, 1, 1);
                string Col = GetColumnName(dtSeg.Columns.Count - 1);
        ...
        public static int ReviewerQ(string Month, string Year)
        {
            ...
            #region Reviewer Q
            sheet = book.Worksheets.Add("Reviewer Q");
            DataTable dtreviewQ = new bllReport().GetReviewerQ_Servicing(Month, Year);
            if (dtreviewQ != null)
            {
                dtreviewQ.Columns.Remove("ResultID");
                sheet.InsertDataTable(dtreviewQ, true, 1, 1);
                ...
                {
                    string SCol = GetColumnName(mergecount);
                    string ECol = GetColumnName(mergecount + 5);
                    range = sheet.Range[SCol + "1:" + ECol + "1"];
                    string ValueToUpdate = sheet.Range[SCol + "2"].Value;
                    ValueToUpdate = ValueToUpdate.Replace("-Loan QCed", "");
                    range.Value = ValueToUpdate;
                    range.Merge();
                    HeaderFormat_Static(range);
                    AllBorder_Static(range);

                    for (int i = mergecount; i <= mergecount + 5; i++)
                    {
                        string colname = GetColumnName(i);
                        sheet.Range[colname + "2"].Value = sheet.Range[colname + "2"].Value.Replace(ValueToUpdate + "-", "");
                    }

                    mergecount = mergecount + 6;
                }
        ...
        public static int QualityQ(string Month, string Year)
        {
            ...
            #region Quality Q
            sheet = book.Worksheets.Add("Quality Q");
            DataTable dtQualityQ = new bllReport().GetQualityQ_Servicing(Month, Year);
            if (dtQualityQ != null)
            {
                dtQualityQ.Columns.Remove("ResultID");
                sheet.InsertDataTable(dtQualityQ, true, 1, 1);
                ...
                {
                    string SCol = GetColumnName(mergecount);
                    string ECol = GetColumnName(mergecount + 7);
                    range = sheet.Range[SCol + "1:" + ECol + "1"];
                    string ValueToUpdate = sheet.Range[SCol + "2"].Value;
                    ValueToUpdate = ValueToUpdate.Replace("-Loan Qced", "");
                    range.Value = ValueToUpdate;
                    ...
                    for (int i = mergecount; i <= mergecount + 7; i++)
                    {
                        string colname = GetColumnName(i);
                        sheet.Range[colname + "2"].Value = sheet.Range[colname + "2"].Value.Replace(ValueToUpdate + "-", "");
                    }

                    mergecount = mergecount + 8;
                }
        ...
        public static int SegmentwiseUtilisation(string Month, string Year)
        {
            ...
            #region Segment wise Utilisation
            sheet = book.Worksheets.Add("Segment wise Utilisation");
            DataTable dtSegUtil = new bllReport().GetAvgSalary_Servicing(Month, Year);
            if (dtSegUtil != null)
            {
                dtSegUtil.Columns.Remove("Months");
        ...
        public static int IndividualPerformance(string Month, string Year)
        {
            ...
            #region Individual Performance
            sheet = book.Worksheets.Add("Individual Performance");
            DataTable dtIndPer = new bllReport().GetIndividualPerformance_Servicing(Month, Year);
            if (dtIndPer != null)
            {
                dtIndPer.Columns.Remove("Salary");
                dtIndPer.Columns.Remove("Month");
                dtIndPer.Columns.Remove("Segment");
                dtIndPer.Columns.Remove("Stage");
                sheet.InsertDataTable(dtIndPer, true, 1, 1);
                string Col = GetColumnName(dtIndPer.Columns.Count - 1);
                CellRange range = sheet.Range["A1:" + Col + "1"];
                HeaderFormat_Static(range);
        ...
        public static int ProductionReport(string Month, string Year)
        {
            ...
            #region Production Report
            sheet = book.Worksheets.Add("Production Report");
            DataTable dtProd = new bllReport().GetProductionReport_Servicing(Month, Year);
            if (dtProd != null)
            {
                dtProd.Columns.Remove("ProdID");
                dtProd.Columns.Remove("ProjectID");
        ...
        public static int FeedbackDump(string Month, string Year)
        {
            ...
            #region Feedback Dump
            sheet = book.Worksheets.Add("Feedback Dump");
            DataTable dtfeedback = new bllReport().GetFeedbackdump_Servicing(Month, Year);
            if (dtfeedback != null)
            {
                sheet.InsertDataTable(dtfeedback, true, 1, 1);
                string Col = GetColumnName(dtfeedback.Columns.Count - 1);
        ...
        public static int WeeklyTrendingReport(string Month, string Year)
        {
            ...
            #region Weekly Trending Report
            sheet = book.Worksheets.Add("Weekly Trending Report");
            DataTable dtweekly = new bllReport().GetWeeklyTrending_Servicing(Month, Year);
            if (dtweekly != null)
            {
                sheet.InsertDataTable(dtweekly, true, 1, 1);
                string Col = GetColumnName(dtweekly.Columns.Count - 1);
        ...
        public static int MonthlyTrendingReport(string Month, string Year)
        {
            ...
            DataTable dtmonthly = new bllReport().GetMonthlyTrending_Servicing(Month, Year);
            if (dtmonthly != null)
            {
        ...
        public static int ErrorTrendingAll(string Month, string Year)
        {
            ...
            DataTable dtErrorTrendingAll = new bllReport().GetErrorTrendingAll_Servicing(Month, Year);
        ...
        public static int ErrorTrendingUser(string Month, string Year)
        {
            ...
            DataTable dtErrorTrendingAll = new bllReport().GetErrorTrendingUser_Servicing(Month, Year);
            if (dtErrorTrendingAll != null)
            {
                sheet.InsertDataTable(dtErrorTrendingAll, true, 1, 1);
                string Col = GetColumnName(dtErrorTrendingAll.Columns.Count - 1);
            ...
            book.Worksheets["Segment Q"].Visibility = WorksheetVisibility.StrongHidden;
            book.Worksheets["Segment wise Utilisation"].Visibility = WorksheetVisibility.StrongHidden;
            book.Worksheets["Weekly Trending Report"].Visibility = WorksheetVisibility.StrongHidden;
        ...
        [WebMethod]
        public static int FeedbackDumpEnglish(string Month, string Year)
        {
            int returnvalue = 1;
            int rowcount = 0;
            int colcount = 0;
            ...
            #region Feedback Dump
            sheet = book.Worksheets.Add("Feedback Dump English");
            DataTable dtfeedback = new bllReport().GetFeedbackdumpEnglish_Servicing(Month, Year);
            if (dtfeedback != null)
            {
                sheet.InsertDataTable(dtfeedback, true, 1, 1);
                string Col = GetColumnName(dtfeedback.Columns.Count - 1);
        ...
        [WebMethod]
        public static int GetFeedbackDump_RQC_1(string Month, string Year)
        {
            ...
            #region Feedback Dump
            sheet = book.Worksheets.Add("Feedback Dump Delivery");
            DataTable dtfeedback = new bllReport().GetFeedbackdump_ServicingRQC(Month, Year);
            if (dtfeedback != null)
            {
                sheet.InsertDataTable(dtfeedback, true, 1, 1);
                string Col = GetColumnName(dtfeedback.Columns.Count - 1);
        ...
        public static int GetFeedbackDump_RW(string Month, string Year)
        {
            ...
            #region Feedback Dump
            sheet = book.Worksheets.Add("Feedback Dump Re-QC");
            DataTable dtfeedback = new bllReport().GetFeedbackdump_ServicingRQC_RW(Month, Year);
            if (dtfeedback != null)
            {
                sheet.InsertDataTable(dtfeedback, true, 1, 1);
                string Col = GetColumnName(dtfeedback.Columns.Count - 1);
