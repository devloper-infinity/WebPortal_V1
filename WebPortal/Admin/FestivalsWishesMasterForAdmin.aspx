<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="FestivalsWishesMasterForAdmin.aspx.cs" Inherits="WebPortal.Admin.FestivalsWishesMasterForAdmin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../Scripts/Functions/FestivalMasterForAdmin.js"></script>


</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <input id="adminfestWish_file" type="hidden" />
                ...
                <div class="festival-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="border rounded bg-light p-2" style="height: 150px; position: relative; overflow: hidden;">
                                    <div id="noFilesPlaceholder" style="display: flex; height: 100%; align-items: center; justify-content: center;" class="text-muted">
                                        ℹ️ No files uploaded yet.
                                    </div>

                                    <div id="selectedFilesWrapper" style="display: none; height: 100%;">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <span id="fileCountHeader" class="fw-bold" style="font-size: 11px;"></span>
                                            <button type="button" class="btn btn-sm btn-outline-danger" style="padding: 1px 5px; font-size: 11px; line-height: 1; border-radius: 3px;" onclick="clearAllFiles()">Clear All</button>
                                        </div>
                                        <div id="fileListContainer" style="height: 110px; overflow-y: auto; padding-right: 2px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive-modern">
                            <table id="admintable_festival" class="table table-hover align-middle">
                                <thead>
                                    <tr>
                                        <th>Action</th>
                                        <th>Sr. #</th>
    ...
    <div class="modal fade" id="adminimagePreviewModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="adminfestivalTitle">Festival Preview</h5>
