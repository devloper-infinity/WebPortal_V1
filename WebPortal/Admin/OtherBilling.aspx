    ...
    <div class="ob-page">
        ...
        <div class="ob-card">
            ...
            <div class="ob-card-body">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ob-field">
                            ...
                            <select id="otherBilling_DealNo" name="otherBilling_DealNo" class="form-control" onchange="getNewDalNo(this);"></select>
                        </div>
                    </div>
                ...
                <div class="row" id="divNewDealNo"  style="display:none;">
                    <div class="col-lg-3 col-md-6">
                        <div class="ob-field">
                            <label for="otherBilling_ProjectType">New Deal #</label>
                            <input type="text" id="otherBilling_NewDealNo" name="otherBilling_DealNo" class="form-control" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-stretch">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="ob-actions">
                            ...
                            <button type="button" id="otherBilling_Verify" name="otherBilling_Verify" class="ob-btn-success" onclick="return btnOtherBilling_Verify();">
