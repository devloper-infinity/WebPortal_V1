  ...
  <%--  <style>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var currentUserID = '<%= HttpContext.Current.User.Identity.Name.ToString() %>';
            document.getElementById("hdUser").innerHTML = currentUserID;

            // const currentusername = parseint(document.getelementbyid("hdnuser").value);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <label id="hdUser" style="display: none;"></label>
    ...
    <div class="row dashboard-row" style="padding-top: 10px; display: none;" id="dash_board" data-intro="This is your main dashboard." data-step="1">
        ...
        <%-- <div id="dash_board" clientidmode="Static">--%>
        <div class="col-md-4">
            ...
            <div class="card card-widget widget-user shadow" style="height: 270px;" data-intro="Here you can quickly access your Productivity, Attendance, and Profile details in one place." data-step="2">
                ...
                <div class="widget-user-header bg-gradient-success">
                    <%--as per new  <h3 class="widget-user-username" id="dashboard_spnusername" onclick="return dashboard_profileinfo();" style="font-style: italic; font-weight: bold; cursor: pointer; text-decoration: underline;"></h3>--%>
                    <h3 id="dashboard_spnusername" clientidmode="Static"></h3>
                    <h6 class="widget-user-desc" id="dashboard_spndesignation"></h6>
                </div>
                <div class="widget-user-image">
                    <%--as per new  <img class="img-circle elevation-2" id="dashboard_userimg" alt="User Avatar" />--%>
                    <img id="dashboard_userimg" clientidmode="Static" class="img-circle elevation-2" alt="User Avatar" />
                </div>
        ...
        <div class="col-md-4" data-intro="<b>Stay Updated</b> Check important announcements, system updates, and action items here." data-step="12">
            <div class="card">
                ...
                <table class="table" id="dashboard_alert_table" clientidmode="Static" style="padding-top: 0px; font-size: 11px; width: 100%; max-height: 220px">
                    <thead>
                        <tr>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-bs-dismiss="modal" style="font-size: 22px;">
                        ✖
                    </button>
                </div>
