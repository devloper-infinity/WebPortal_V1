        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content vrbil-modal-content">
                ...
                <div class="modal-body vrbil-modal-body">
                    ...
                    <!-- ================= ADDITIONAL DETAILS ================= -->
                    <div class="vrbil-additional-wrapper">

                        <div class="vrbil-switch-card">

                            <div class="vrbil-switch-info">

                                <div class="vrbil-switch-symbol">
                                    +
                                </div>

                                <div>
                                    <div class="vrbil-switch-title">
                                        Add Additional Details
                                    </div>

                                    <div class="vrbil-switch-description">
                                        Enable to enter additional information
                                    </div>
                                </div>
                            ...
                            <label class="vrbil-switch">
                                ...
                                <input type="checkbox"
                                    id="vrbil_additional"
                                    onchange="vrbil_toggleAdditional();" />
                        ...
                        <!-- Dependent fields -->
                        <div id="vrbil_additionalFields"
                            class="vrbil-dependent-section"
                            style="display: none;">
