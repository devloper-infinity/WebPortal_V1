<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Accounts.Master" AutoEventWireup="true" CodeBehind="ImportCCStatement.aspx.cs" Inherits="WebPortal.Accounts.ImportCCStatement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="card-body">
                ...
                <table class="table">
                    <tr>
                        ...
                        <td style="width: 150px;">
                            <select id="import_year" name="import_year" class="form-control" onchange="return getExistingData();">
                                <option value="">Select</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 100px;">
                            ...
                            &nbsp;&nbsp;
                            <a href="../Templates/StatementFormat.xlsx" target="_blank"><b>Download Format</b></a>
                        </td>
                    </tr>
                </table>
                <hr />
                <table class="table" id="tblsendemail" style="display: none;">
                    <tr>
                        <td><b>Employee:</b></td>
                        <td>
                            <select id="import_raise_employee" name="import_raise_employee" class="form-control" style="width: 350px;">
                                <option value="">Select</option>
                                <option value="209">MDK : Mahesh Khollam</option>
                                <option value="9852">LCO : Rahul Yadav</option>
                            </select>
                        </td>
                        <td style="display: none;"><b>Header:</b></td>
                        <td style="display: none;">
                            <label id="import_raise_header" class="form-control" style="width: 300px;"></label>
                        </td>
                        <td><b>Remark:</b></td>
                        <td>
                        ...
                        <td>
                            <button class="btn btn-primary" type="button" id="import_raise_btnsubmit" onclick="return import_raise_submit();">Send Email</button>
                        </td>
                    </tr>
                </table>
                <table class="table" id="invVerification" style="width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="sort border-top" style="text-wrap: nowrap;">Add Remark</th>

                            <th class="sort border-top" style="text-wrap: wrap;">Email Status</th>
                            ...
                            <th class="sort border-top" style="text-wrap: wrap;">Accounts Remark</th>
    ...
    <div class="modal fade" id="import_raise_popup">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table">
                        <tr>
                            <td><b>Statement Header:</b></td>
                            <td>
                                <label id="import_remark_header" class="form-control" style="width: 300px;"></label>
                            </td>
                            <td><b>Amount:</b></td>
                            <td>
                                <label id="import_remark_amount" class="form-control" style="width: 300px;"></label>
                            </td>
                        </tr>
                       <%-- <tr>
                        ...
                        <tr>
                            <td><b>System Remark:</b></td>
                            <td>
                                <label id="import_remark_systemremark" class="form-control" style="width: 300px;"></label>
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td><b>Update Paid Date :</b></td>
                            <td>
                                <input type="date" id="import_remark_UpPaidDate" name="import_remark_UpPaidDate" class="form-control" style="width: 200px;"/>
                            </td>
                            <td><b>Remark:</b></td>
                            <td>
                                <textarea id="import_remark_remark" name="import_remark_remark" class="form-control" style="width: 300px;"></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-primary" onclick="return import_remark_AddRemark();">Add Remark</button>
