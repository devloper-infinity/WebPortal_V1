<%@ Page Title="" Language="C#" MasterPageFile="~/Production/Production.Master" AutoEventWireup="true" CodeBehind="ProjectTrackingFieldConfiguration.aspx.cs" Inherits="WebPortal.Production.ProjectTrackingFieldConfiguration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function renderFieldTable(fields) {
            ...
            $("#table_ProjectTrackingFields tbody").html(html || "<tr><td colspan='12' class='text-center'>No fields configured.</td></tr>");
        }
        ...
        function setStatusOptionsMode(isStatusOptionsMode) {
            if (isStatusOptionsMode) {
                $("#txtFieldName, #ddlFieldDataType, #chkActualProcess, #txtDisplayOrder, #chkFieldRequired, #chkFieldVisible, #chkFieldEditable, #chkForBilling, #ddlDateFormat").prop("disabled", true);
                $("#txtFieldOptions").prop("disabled", false).focus();
                $("#btnSaveFieldConfig").html("<i class='fas fa-save'></i>&nbsp;Save Status Options");
                return;
            }

            $("#txtFieldName, #ddlFieldDataType, #chkActualProcess, #txtDisplayOrder, #chkFieldRequired, #chkFieldVisible, #chkFieldEditable, #chkForBilling").prop("disabled", false);
    ...
    <div class="pt-config-page">
        <div class="pt-config-shell">
            <div class="pt-config-hero">
                ...
                <div>
                    <a href="ProjectTrackingSheet.aspx" class="btn btn-sm btn-outline-primary pt-config-quick-link">
            ...
            <div class="pt-config-panel">
                ...
                <div class="pt-config-table-wrap">
                    <table class="table table-bordered table-sm pt-config-table" id="table_ProjectTrackingFields">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="12" class="text-center">Select a project.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
