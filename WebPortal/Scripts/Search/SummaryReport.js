(function ($) {
    ...
    function reportColumns(values) {
        ...
        return [column("Sr.", "_sr"), column("Code", "Code"), column("Project No", "ProjectNumber"), column("Process", "Process"), column("Order No", "ClientOrderNo"), column("Order Date", "OrderDate"), column("Product Type", "ProductType"), column("Process Status", "ProcessStatus"), column("Online / Offline", "OnOffLine"), column("Assigned Date", "AddDate"), column("TAT", "TAT")];
    }
