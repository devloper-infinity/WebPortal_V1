<%@ Page Title="" Language="C#" MasterPageFile="~/IT/Admin.Master" AutoEventWireup="true" CodeBehind="Brand.aspx.cs" Inherits="WebPortal.IT.Brand" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="asset-hero">
        <h4><i class="fas fa-copy"></i>&nbsp;&nbsp;Brand Master</h4>
        <p>Create and manage asset brand names for consistent inventory tracking and reporting.</p>
    </div>
    ...
    <div class="asset-page-shell">
        <div class="asset-panel">
            <div class="asset-panel-header">
                <div>
                    <h5>Add Brand</h5>
                    <span>Enter a brand name to maintain the asset brand master list.</span>
                </div>
            </div>
            <div class="asset-panel-body">
                <div class="asset-form-grid">
                    ...
                    <div class="asset-actions">
                        <button id="brand_btnsubmit" name="brand_btnsubmit" class="btn btn-primary" onclick="return brand_submit();">Submit</button>
                        <button id="brand_btnreset" name="brand_btnreset" class="btn btn-secondary" onclick="location.reload();" style="display: none;">Reset</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="asset-panel">
            <div class="asset-panel-header">
                <div>
                    <h5>Records</h5>
                    <span>Search, review, and manage saved brand entries.</span>
                </div>
            </div>
            <div class="asset-panel-body asset-table-wrap">
                <table class="table table-bordered table-hover" id="brandlist" style="width: 100%;">
                    <thead>
                        <tr>
    ...
    <div class="modal fade" id="brand_dverror">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="brand_errmsg"></h6>
                </div>
                <div class="modal-footer align-content-center">
                    <button class="btn btn-primary" type="button" id="brand_btnMessage" onclick="return brand_Message();">Okay</button>
                </div>
            </div>
        </div>
    </div>
