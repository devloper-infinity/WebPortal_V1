<%@ Page Title="" Language="C#" MasterPageFile="~/IT/Admin.Master" AutoEventWireup="true" CodeBehind="AssetStatus.aspx.cs" Inherits="WebPortal.IT.AssetStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="asset-hero">
        <h4><i class="fas fa-copy"></i>&nbsp;&nbsp;Asset Status</h4>
        <p>Manage status labels used during allocation, repair, recovery, and reporting.</p>
    </div>
    <div class="asset-page-shell">
        <div class="asset-panel">
            <div class="asset-panel-header">
                <div>
                    <h5>Add Asset Status</h5>
                    <span>Create statuses used to track asset availability and lifecycle state.</span>
                </div>
            </div>
            <div class="asset-panel-body">
                <div class="asset-form-grid">
                    <div class="asset-field">
                        <label>Asset Status</label><input type="text" id="assetstatus_status" name="assetstatus_status" class="form-control" />
                    </div>
                    <div class="asset-actions">
                        <button type="submit" id="assetstatus_btnsubmit" name="assetstatus_btnsubmit" class="btn btn-primary" onclick="return assetstatus_submit();">Submit</button>
                        <button type="button" id="assetstatus_btnreset" name="assetstatus_btnreset" class="btn btn-secondary" onclick="assetstatus_resetForm();" style="display: none;">Reset</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="asset-panel">
            ...
            <div class="asset-panel-body asset-table-wrap">
                <table class="table table-hover" id="table_assetstatus" style="width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="sort border-top" style="text-wrap: nowrap;">Asset Status</th>
                            <th class="sort border-top" style="text-wrap: nowrap;">Added By</th>
                            <th class="sort border-top" style="text-wrap: nowrap;">Added Date</th>
                            <th class="sort border-top" style="text-wrap: nowrap; display: none;">StatusId</th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
    ...
    <div class="modal fade" id="assetstatus_dverror">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="assetstatus_errmsg"></h6>
                </div>
                <div class="modal-footer align-content-center">
                    <button class="btn btn-primary" type="button" data-dismiss="modal" id="assetstatus_btnMessage">Okay</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
