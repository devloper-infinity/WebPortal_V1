...
namespace WebPortal.App_Code.BLL
{
    public class bllProjectTracking
    {
        ...
        {
            return dalProjectTracking.SaveFieldConfiguration(fieldConfigId, projectId, fieldName, dataType, optionsText, isRequired, isUniqueField, isVisible, isEditable, isForBilling, isBillingParameter, displayOrder, isProcessColumn, dateFormat, userId);
        }
        ...
        {
            return SaveFieldConfiguration(fieldConfigId, projectId, fieldName, dataType, optionsText, isRequired, false, isVisible, isEditable, isForBilling, false, displayOrder, isProcessColumn, dateFormat, userId);
        }
